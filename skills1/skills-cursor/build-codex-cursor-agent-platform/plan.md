...
| 6 | **Multi-threading** | Parallel bootstrap, reviews, dynamic specialists | Partial | `agent_runtime/parallel_actions.py` |
...
| Terminal / Git / Tests | Codex tools + allowlisted sandbox |
