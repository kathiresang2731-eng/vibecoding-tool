...
def test_gemini_client_log_token_usage_writes_dedicated_usage_file_without_terminal_noise(tmp_path, capsys):
  logger = GeminiTokenUsageLogger(
  ...
  assert "[WorktualTokenUsage]" not in terminal_output
