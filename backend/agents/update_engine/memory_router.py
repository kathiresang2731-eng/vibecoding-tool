...
try:
  ...
  from ..memory.project_knowledge import select_project_ui_knowledge
except ImportError:
  ...
  from agents.memory.project_knowledge import select_project_ui_knowledge
...
def build_scope_memory_payload(
  *,
  ...
  if include_session_memory and store is not None and user is not None and chat_session_id:
