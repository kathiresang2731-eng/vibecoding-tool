  ...
  return {
    "generated_website": {
      ...
      "theme": {
        ...
        "style_direction": "Clean SaaS landing page",
      },
      "sections": [
        {
          "name": "Hero",
      ...
      "files": [
        {
          ...
          "code": (
            ...
            "      <p className=\"text-sm font-bold uppercase tracking-normal text-teal-700\">Mock Landing Page</p>\n"
            "      <h1 className=\"mt-4 max-w-3xl text-5xl font-black\">Launch a polished website from one prompt</h1>\n"
            "      <p className=\"mt-5 max-w-2xl text-lg text-slate-600\">A deterministic local artifact for builder development.</p>\n"
            "    </main>\n"
            "  );\n"
            "}\n"
          ),
