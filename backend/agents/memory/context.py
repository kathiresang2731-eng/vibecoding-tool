...
def build_unified_memory_context_block(
  ...
  *,
  ...
  episodic_block = build_episodic_context_block(episodic, prompt=prompt)
  if episodic_block:
...
def build_agent_flow_memory_block(
  ...
  *,
  ...
  try:
    from ..chat_history import build_compact_chat_continuity_block
  except ImportError:
    from agents.chat_history import build_compact_chat_continuity_block
