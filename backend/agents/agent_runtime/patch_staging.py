...
from backend.execution.patch import PatchEngineError, apply_patches_to_files
from backend.execution.patch.diff_builder import build_unified_patches_from_file_changes
