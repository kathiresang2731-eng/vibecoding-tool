...
from .builders import make_v1_event
from .constants import _LEGACY_TOOL_STEPS
...
def _is_parallel_progress_step(step: str) -> bool:
  if step.startswith(("agent.parallel.", "agent.worker.", "update.analysis.", "orchestrator.wave.")):
    return True
  return step in {"context.analysis", "update.clarification.required", "agent.decision"}
